#!/usr/bin/env node
import { n as readJsoncFile } from "./read-jsonc-gVkF3wF0.js";
import { n as runSubprocess, t as isToolInstalled } from "./subprocess-DVGG5JHI.js";
...
const lintEngine = {
	...
	async run(context) {
		...
		if (languages.includes("typescript") || languages.includes("javascript")) {
			...
			if (context.config.lint.typecheck) promises.push(import("./typecheck-BTht0JYf.js").then((mod) => mod.runTypecheck(context)));
		}
		if (context.frameworks.includes("expo") && context.config.lint.expoDoctor) promises.push(import("./expo-doctor-CWRS9Mbb.js").then((mod) => mod.runExpoDoctor(context)));
