...
const lintEngine = {
	...
	async run(context) {
		...
		if (languages.includes("typescript") || languages.includes("javascript")) {
			...
			if (context.config.lint.typecheck) promises.push(import("./typecheck-CDpDx5am.js").then((mod) => mod.runTypecheck(context)));
		}
		if (context.frameworks.includes("expo") && context.config.lint.expoDoctor) promises.push(import("./expo-doctor-DsQyK7fp.js").then((mod) => mod.runExpoDoctor(context)));
