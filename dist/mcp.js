#!/usr/bin/env node
import { a as resetGitIgnoreSnapshots, c as toPosix, i as getIgnoredPaths, n as readJsoncFile, o as projectRelativePosix, r as dropGitIgnoredPaths, s as relativePosix } from "./read-jsonc-9nk5JZ5W.js";
import { a as warnSubprocessFailure, i as runSubprocess, n as isMissingToolError, r as isToolInstalled, t as chunkFilePaths } from "./subprocess-CyNYhvlK.js";
...
const lintEngine = {
	...
	async run(context) {
		...
		if (languages.includes("typescript") || languages.includes("javascript")) {
			...
			if (context.config.lint.typecheck) promises.push(import("./typecheck-D0wZYqeD.js").then((mod) => mod.runTypecheck(context)));
		}
		if (context.frameworks.includes("expo") && context.config.lint.expoDoctor) promises.push(import("./expo-doctor-Bzb0CABl.js").then((mod) => mod.runExpoDoctor(context)));
