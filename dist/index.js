import { n as relativePosix, t as projectRelativePosix } from "./paths-C8d-qfG2.js";
import { n as runSubprocess, t as isToolInstalled } from "./subprocess-D-8bGo55.js";
import { a as getEngineLabel, i as ENGINE_INFO, r as scoreImpactForRule, t as summarizeFindingAssessments } from "./finding-assessment-BfpwxTO2.js";
import { t as APP_VERSION } from "./version-BSbYWUqQ.js";
...
const runScanBody = async (resolvedDir, config, options, projectInfo, scanScope) => {
	...
	if (options.sarif) {
		const { buildSarifLog } = await import("./sarif-DMWV80fv.js");
		console.log(JSON.stringify(buildSarifLog(results), null, 2));
		return completion;
	}
	if (options.json) {
		const { buildJsonOutput } = await import("./json-DYneANvC.js");
